...
public class DevoteeService {
	final static Logger logger = Logger.getLogger(DevoteeService.class);
	@GET
	@Path("/addNewDevotee")
	...
	public Response addNewDevotee(
		...
		logger.debug("Calling addNewDevotee");
		...
		try {
			...
			try {
				...
				logger.error("Invalid date format provided for devotee date of birth.");
				return Response
						.serverError()
			...
			try {
				...
				logger.error("Invalid date format provided for devotee introduction date.");
				return Response
						.serverError()
	...
	private void addMentor(int mentorId, String mentorName,
		...
		logger.debug("Calling addMentor");
		IRepositroyCommunication repository = null;
		PreparedStatement statement = null;
		try {
			repository = RepositoryCommunicationFactory.newInstance();
	...
	public static Response getProgramParticipants(@QueryParam("text") String text) {
